				...
				<div class="row">
					<div class="col-lg-8 mx-auto">
						...
						<!-- Project Details Go Here -->
							<h2 class="text-uppercase">Poissonnerie du Port Chez Elise</h2>
							<p class="item-intro text-muted">Site Web pour une poissonnerie</p>
							<div class="row">
								<a class="col-md-3 offset-md-2 btn btn-success" href="http://www.poissonnerieduport.fr" target="_blank">Voir le site</a>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-8 mx-auto">
						<div class="modal-body">
						<!-- Project Details Go Here -->
							<h2 class="text-uppercase">Perlouse Pigale</h2>
							<p class="item-intro text-muted">Bar à huitres</p>
							<div class="row">
								<a class="col-md-3 offset-md-2 btn btn-success" href="http://www.perlousepigalle.fr" target="_blank">Voir le site</a>
								<button class="col-md-3 offset-md-2 btn btn-warning" data-dismiss="modal" type="button"><i class="fa fa-times"></i> Fermer</button>
							</div>
						</div>
					</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-8 mx-auto">
						<div class="modal-body">
						<!-- Project Details Go Here -->
							<h2 class="text-uppercase">Le Snake</h2>
							<p class="item-intro text-muted">Le célèbre jeux du serpent</p>
							<div class="row">
								<a class="col-md-3 offset-md-2 btn btn-success" href=http://www.nicolasduquesne.com/public/game/snake.html target="_blank">Voir le site</a>
								<button class="col-md-3 offset-md-2 btn btn-warning" data-dismiss="modal" type="button"><i class="fa fa-times"></i> Fermer</button>
							</div>
						</div>
					</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-8 mx-auto">
						<div class="modal-body">
						<!-- Project Details Go Here -->
							<h2 class="text-uppercase">Osteo Kine Sport</h2>
							<p class="item-intro text-muted">Site internet pour le cabinet de kinésitérapie et d'ostéopathie à Audenge</p>
							<div class="row">
								<a class="col-md-3 offset-md-2 btn btn-success" href="http://www.osteo-kine-sport.fr" target="_blank">Voir le site</a>
								<button class="col-md-3 offset-md-2 btn btn-warning" data-dismiss="modal" type="button"><i class="fa fa-times"></i> Fermer</button>
							</div>
						</div>
					</div>
